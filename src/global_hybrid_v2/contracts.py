...
class RC01StopCondition(StrEnum):
    INTERNAL_ENFORCEMENT_COMPLETE = "INTERNAL_ENFORCEMENT_COMPLETE"
    HOST_COMPLETE_MEDIATION_UNAVAILABLE = "HOST_COMPLETE_MEDIATION_UNAVAILABLE"
    PLATFORM_BOUNDARY_PARKED = "PLATFORM_BOUNDARY_PARKED"
